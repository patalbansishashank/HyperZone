...
Usage: hzctl.py <focus|move|tomon|push|swap|toggle-float|snap-drop|float-drop|drag-start|drag-mod|drag-drop|rearrange|retile|dump> [arg]
"""
import os
import socket
import sys
...
COMMANDS = ("focus", "move", "tomon", "push", "swap", "toggle-float", "snap-drop",
            "float-drop", "drag-start", "drag-mod", "drag-drop",
            "retile", "rearrange", "dump", "locate")
ARGS = (None, "left", "right", "up", "down",
        "snap", "float", "tile", "both",                       # drag-start intents
        "ctrl-down", "ctrl-up", "shift-down", "shift-up")      # drag-mod events
